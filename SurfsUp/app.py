...
def welcome():
    ...
    return (
        ...
        f" <img width='600' src='https://cdn.imgbin.com/6/7/20/imgbin-waikiki-hawaiian-beaches-honolulu-keonenui-desktop-beaches-tYWeJynCS83LXS6ws7sRMQQ3r.jpg'/ >"
...
def determine_temps_for_date_range(start, end):
    ...
    if no_temperature_data == True:
        return f"No temperature data found. Please try another date range."
    else:
